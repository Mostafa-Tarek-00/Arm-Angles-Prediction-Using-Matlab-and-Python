...
%net.trainParam.batchSize = 16;

%net1 = train(net, inptrain, outtrain);
...
p1 = sim(net1, inptrain);
error1 = p1 - outtrain;

input_size = net1.inputs{1}.size;
output_size = net1.outputs{end}.size;

fprintf('Input Size of the Neural Network: %d\n', input_size);
fprintf('Output Size of the Neural Network: %d\n', output_size);

predictions = sim(net1, inptest);
