...
%net3 = newrb(inptrain, outtrain, 0.001);
%save('net_new_rb.mat', 'net3');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
load('net_new_rb.mat', 'net3');

p1 = sim(net3, inptrain);
error1 = p1 - outtrain;

input_size = net3.inputs{1}.size;
output_size = net3.outputs{end}.size;

fprintf('Input Size of the Neural Network: %d\n', input_size);
fprintf('Output Size of the Neural Network: %d\n', output_size);

predictions = sim(net3, inptest);
